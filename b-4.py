def main():
    ...
    osaka_stations = [weather['station'] for weather in weather_information if weather['prefecture'] == '大阪府']
    print(','.join(osaka_stations))
    # Q3. 福岡県の平均気温を計算してください(14.0となればOK)
    fukuoka_temperatures = [weather['temperature'] for weather in weather_information if weather['prefecture'] == '福岡県']
